...
-**Semantic HTML** using tags like `<main>`, `<section>`, `<h1>`, `<p>`, `<ul>`, etc.
-**SEO Meta Tags** including `description`, `author`, and `keywords`
-**Open Graph Tags** for rich previews when shared on social media
-**Favicon** properly linked and displayed in browser tab

## How to Use

1. Clone the repository: git clone https://github.com/ChangoFurioso/FIRST-PROJECT.git
